...
-- Clear search highlight with Ctrl-Space
set("n", "<C-space>", ":noh<CR>", opts)

-- Escape with Ctrl-Space in insert/visual mode
...
-- (LazyVim adds a lot of keymaps, we'll keep them but can disable specific ones here)
