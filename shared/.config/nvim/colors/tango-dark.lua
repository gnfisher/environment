...
hi("StatusLine",    { fg = colors.alum1, bg = colors.alum5_5, gui = "bold" })
...
hi("TabLine",       { fg = colors.alum4, bg = colors.alum5 })
hi("TabLineFill",   { fg = colors.alum4, bg = colors.alum5 })
hi("TabLineSel",    { fg = colors.alum1, bg = colors.alum6 })
